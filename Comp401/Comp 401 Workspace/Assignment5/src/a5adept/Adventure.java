...
public class Adventure {
	...
	public Adventure(Difficulty mode, Squad squad) {
		...
		washingtonDC = new CityImpl("Washington, D.C.", null, null,mode == Difficulty.EASY);
		newyork = new CityImpl("New York", null, null, false);
		chicago = new CityImpl("Chicago", null, null, false);
		austin = new CityImpl("Austin", null, null, mode == Difficulty.MEDIUM);
		...
		paloalto = new CityImpl("Palo Alto", null, null,mode == Difficulty.HARD);
